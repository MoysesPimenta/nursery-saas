        ...
        <div className="flex-1 flex flex-col gap-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              disabled={disabled}
              className={cn(
                'w-full pl-10 pr-3 py-2 border border-border rounded-md text-sm',
                'bg-white text-slate-900 placeholder-slate-400',
                'focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-0',
                'disabled:opacity-50 disabled:cursor-not-allowed',
                'dark:bg-slate-950 dark:text-slate-50 dark:placeholder-slate-600 dark:focus:ring-slate-300'
              )}
            />
          </div>
        </div>
